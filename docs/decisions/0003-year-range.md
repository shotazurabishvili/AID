...
- 2020–2022 introduces COVID-related noise on both enrollment (school closures) and learning (test postponement, score effects). UNESCO COVID closures data is the control.
