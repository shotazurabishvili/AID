#### UIS-augmented listwise robustness (PAP-0006 Robustness 1)

Refit of Model 2 spec 2e with `uis_priv_exp_pct_gdp` added to the regressor stack. Listwise-complete subset on the 2010-2020 primary window. Per PAP-0006, this is *Robustness 1* of three originally committed (Robustness 2 = multiple imputation, retired per PAP-0012 after MCAR rejection; Robustness 3 = the primary UIS-dropped specification).
